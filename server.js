...
const awsIot = require('aws-iot-device-sdk');
const mysql = require('mysql');
const mqtt = require('mqtt');  // MQTT client for Mosquitto
...
const mqttClient = mqtt.connect('mqtt://localhost');  // Connect to Mosquitto broker running locally
...
mqttClient.on('connect', () => {
  ...
  mqttClient.subscribe('sensor_data/#', (err) => {
    if (err) {
      ...
      console.log('Successfully subscribed to sensor_data/# topic.');
    }
  });
});
